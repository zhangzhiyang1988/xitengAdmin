...
const proxy = {
  ...
  'POST /api/onediscountorder/orderList': getOrderListData,
  'POST /api/onediscountgame/productList': getProductListData,
  ...
  // },
  // 'POST /api/onediscountclient/confirmWithDrawFail':(id)=>{
  //   confirmWithDrawFail(id);
  // },
